...
plt.plot(train_loss_list, label='Adagrad')
plt.xlabel("Epochs")
plt.ylabel("Training loss")
plt.title("CIFAR-10 Training Loss for Adagrad Optimizer (AlexNet)")
plt.legend(loc='upper right')
plt.show()

plt.figure(figsize=(10, 6))
plt.plot(accuracy_list, label='Adagrad')
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("CIFAR-10 Training Accuracy for Adagrad Optimizer (AlexNet)")
