...
betas = (0.9, 0.999)  # Adamax coefficients
...
optimizer = optim.Adamax(model.parameters(), lr=learning_rate, betas=betas, weight_decay=5e-4)
...
plt.title("CIFAR-10 Training Loss for Adamax Optimizer (AlexNet)")
...
plt.xlabel("Epochs")
plt.ylabel("Accuracy (%)")
plt.title("CIFAR-10 Training Accuracy for Adamax Optimizer (AlexNet)")
